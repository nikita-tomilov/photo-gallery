...
fun File.isPhoto() = this.isFileWithExtension(setOf("jpg", "jpeg", "heic", "png")) && this.isNotMacosPreview()
fun File.isVideo() = this.isFileWithExtension(setOf("avi", "mp4", "mov")) && this.isNotMacosPreview()
